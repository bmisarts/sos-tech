    ...
    <div class="container pt-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt bg1 me-2"></i>Makepe, saint Tropez, Douala Cameroun</p>
                <p class="mb-2"><i class="bi bi-envelope-open bg1 me-2"></i><a class="text-white" href="mailto:sosservicestech@sosservicestech.com">sosservicestech@sosservicestech.com</a></p>
                <p class="mb-0"><i class="bi bi-telephone bg1 me-2"></i>+237 652 061 510 / +237 6 55 07 71 19</p>
            </div>
            <div class="col-lg-4 col-md-6">
