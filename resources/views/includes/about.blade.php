...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" id="toHide" style="min-height: 500px;">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">Nous nous chargeons également de la maintenance et des installations des systèmes de sécurité déjà existants.</p>
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                            <div class="btn1 d-flex flex-column justify-content-center text-center border-bottom border-5 border-secondary rounded p-3 fg1" style="height: 200px;">
                                ...
                                <h4 class="text-white mb-0">Amour du service</h4>
                            </div>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.9s">
                            <div class="btn2 d-flex flex-column justify-content-center text-center border-bottom border-5 border-primary rounded p-3 fg2" style="height: 200px;">
                                ...
                                <h4 class="text-white mb-0">Assurance qualité</h4>
                            </div>
                        </div>
                    </div>
                </div>
